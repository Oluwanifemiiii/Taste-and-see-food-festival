...
export default function About({ onNav }) {
  return (
    <main style={{ minHeight: '100vh', background: '#0F1208' }}>
      {/* Manifesto hero */}
      <section style={{ minHeight: '75vh', display: 'flex', alignItems: 'center', padding: '140px 48px 100px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: 960, position: 'relative', zIndex: 1 }}>
          ...
          <h1 style={{ fontSize: 'clamp(36px,5.5vw,72px)', fontFamily: "'Yeseva One',serif", color: '#EFE8D5', lineHeight: 1.1, marginBottom: 40 }}>
            Nigeria has more than 250 ethnic groups.<br />
            <span style={{ color: '#C8891F' }}>Each one has a table<br />worth gathering around.</span>
          </h1>
          <p style={{ fontSize: 17, lineHeight: 1.8, color: '#A89B80', maxWidth: 560 }}>We built the Taste &amp; See Festival to make sure those tables are never empty, never forgotten, and never reduced to a footnote in someone else's food story.</p>
        </div>
      </section>
      ...
      <section style={{ padding: '100px 48px', maxWidth: 1440, margin: '0 auto', display: 'flex', gap: 80, alignItems: 'flex-start', flexWrap: 'wrap' }}>
        ...
        <div style={{ flex: .58, minWidth: 280 }}>
          ...
          <h2 style={{ fontSize: 40, fontFamily: "'Yeseva One',serif", color: '#EFE8D5', marginBottom: 24, lineHeight: 1.1 }}>About Lamide Foods</h2>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24, padding: 32, background: '#1E2418', border: '.5px solid #2A3020', borderRadius: 12 }}>
            {[['2019', 'Founded in Lagos'], ['250+', 'Ethnic groups in Nigeria'], ['26', 'Festival events annually'], ['13+', 'Ethnic groups featured']].map(([n, label]) => (
              <div key={label}>
                <p style={{ fontSize: 32, fontFamily: "'Yeseva One',serif", color: '#C8891F', marginBottom: 6 }}>{n}</p>
      ...
      <section style={{ padding: '100px 48px', background: '#1E2418' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 64 }}>
            ...
            <h2 style={{ fontSize: 'clamp(28px,4vw,44px)', fontFamily: "'Yeseva One',serif", color: '#EFE8D5', lineHeight: 1.2, maxWidth: 720, margin: '0 auto' }}>"To create a living, recurring archive of Nigerian food heritage — one feast at a time."</h2>
          </div>
          <div className="adire" style={{ width: 160, margin: '0 auto 64px', borderRadius: 3 }} />
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 32 }} className="col1">
            {[
      ...
      <section style={{ padding: '100px 48px', maxWidth: 1440, margin: '0 auto' }}>
        ...
        <h2 style={{ fontSize: 40, fontFamily: "'Yeseva One',serif", color: '#EFE8D5', marginBottom: 56 }}>Built by those who care</h2>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 32 }} className="col1">
      ...
      <section style={{ padding: '100px 48px', textAlign: 'center', background: '#0F1208' }}>
        ...
        <h2 style={{ fontSize: 40, fontFamily: "'Yeseva One',serif", color: '#EFE8D5', marginBottom: 16 }}>Come to the table.</h2>
