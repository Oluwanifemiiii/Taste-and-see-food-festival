  ...
  return (
    <main>
      ...
      <section style={{ position: 'relative', width: '100%', height: '100vh', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <div style={{ position: 'relative', zIndex: 2, textAlign: 'center', maxWidth: 960, padding: '0 40px' }}>
          ...
          <div className="fu fu2 adire" style={{ width: 240, margin: '0 auto 28px' }} />
          <h1 className="fu fu3" style={{ fontSize: 'clamp(56px,7vw,96px)', lineHeight: 1, fontFamily: "'Yeseva One',serif", color: '#EFE8D5', marginBottom: 24 }}>Eat. Remember. Return.</h1>
          <p className="fu fu4" style={{ fontSize: 15, lineHeight: 1.75, color: '#A89B80', maxWidth: 500, margin: '0 auto 48px' }}>Nigeria's premier culinary heritage festival, celebrating the food stories of every ethnic group, one dish at a time.</p>
          <div className="fu fu5" style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
            <button onClick={() => onNav('checkout')}
              style={{ background: '#C8891F', color: '#0F1208', border: 'none', borderRadius: 2, padding: '16px 36px', fontSize: 12, fontWeight: 600, letterSpacing: '.10em', textTransform: 'uppercase', cursor: 'pointer', transition: 'background .2s' }}
            ...
            <button onClick={() => onNav('events')}
              style={{ background: 'transparent', color: '#EFE8D5', border: '1px solid rgba(239,232,213,.5)', borderRadius: 2, padding: '16px 36px', fontSize: 12, fontWeight: 600, letterSpacing: '.10em', textTransform: 'uppercase', cursor: 'pointer', transition: 'all .2s' }}
              onMouseOver={e => e.currentTarget.style.borderColor = '#EFE8D5'}
              onMouseOut={e => e.currentTarget.style.borderColor = 'rgba(239,232,213,.5)'}>
              View Upcoming Events
            </button>
          </div>
        </div>
        <div className="fu fu6" style={{ position: 'absolute', bottom: 48, left: 0, right: 0, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
          {[
            ...
            <div key={i} style={{ display: 'flex', alignItems: 'center' }}>
              {i > 0 && <div style={{ width: .5, height: 60, background: '#2A3020' }} />}
              <div style={{ textAlign: 'center', padding: '0 48px' }}>
                <div style={{ fontSize: 52, lineHeight: 1, fontFamily: "'Yeseva One',serif", color: '#C8891F' }}>{val}</div>
      ...
      <section style={{ display: 'flex', minHeight: 600 }}>
        <div style={{ flex: 1, background: '#1E2418', padding: '80px 60px', display: 'flex', flexDirection: 'column', justifyContent: 'center', borderRight: '3px solid #C8891F' }}>
          ...
          <h2 style={{ fontSize: 46, lineHeight: 1.1, fontFamily: "'Yeseva One',serif", color: '#EFE8D5', marginBottom: 24 }}>Ethnic Food<br />Showcase</h2>
        ...
        <div style={{ flex: 1, background: '#252C1A', padding: '80px 60px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          ...
          <h2 style={{ fontSize: 46, lineHeight: 1.1, fontFamily: "'Yeseva One',serif", color: '#EFE8D5', marginBottom: 24 }}>Old vs New</h2>
      ...
      <section style={{ padding: '120px 48px', maxWidth: 1440, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 64 }}>
          ...
          <h2 style={{ fontSize: 48, fontFamily: "'Yeseva One',serif", color: '#EFE8D5' }}>Don't Miss What's Coming</h2>
        </div>
      ...
      {/* PHILOSOPHY */}
      <section style={{ padding: '120px 48px', maxWidth: 1440, margin: '0 auto', display: 'flex', gap: 80, alignItems: 'flex-start', flexWrap: 'wrap' }}>
        <div style={{ flex: .6, minWidth: 300 }}>
          ...
          <blockquote style={{ fontSize: 'clamp(32px,4vw,52px)', lineHeight: 1.15, fontFamily: "'Yeseva One',serif", color: '#EFE8D5' }}>"We don't just serve food.<br />We serve memory."</blockquote>
        </div>
        <div style={{ flex: .4, minWidth: 260, paddingTop: 80 }}>
      ...
      {/* TICKET TIERS */}
      <section style={{ padding: '120px 48px', background: '#1E2418' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 64 }}>
            ...
            <h2 style={{ fontSize: 48, fontFamily: "'Yeseva One',serif", color: '#EFE8D5' }}>Choose Your Seat at the Table</h2>
          </div>
          <div style={{ display: 'flex', gap: 24, alignItems: 'stretch', flexWrap: 'wrap' }}>
            {/* Regular */}
            <div style={{ flex: 1, minWidth: 240, background: '#0F1208', border: '.5px solid #2A3020', borderRadius: 12, padding: 40, display: 'flex', flexDirection: 'column' }}>
            ...
            {/* Premium */}
            <div style={{ flex: 1, minWidth: 240, background: '#1E2418', border: '1px solid #C8891F', borderRadius: 12, padding: 40, display: 'flex', flexDirection: 'column', position: 'relative', transform: 'scale(1.04)' }}>
            ...
            {/* VIP */}
            <div style={{ flex: 1, minWidth: 240, background: '#221810', border: '1px solid #A33D21', borderRadius: 12, padding: 40, display: 'flex', flexDirection: 'column' }}>
      ...
      {/* NEWSLETTER */}
      <section style={{ padding: '100px 48px', background: '#0F1208', textAlign: 'center' }}>
        <h2 style={{ fontSize: 32, fontFamily: "'Yeseva One',serif", color: '#EFE8D5', marginBottom: 8 }}>Be First to Know</h2>
        <p style={{ fontSize: 15, color: '#A89B80', marginBottom: 40 }}>New events, featured chefs, limited tickets — straight to your inbox.</p>
        <div style={{ display: 'flex', maxWidth: 460, margin: '0 auto 48px' }}>
          <input type="email" placeholder="your@email.com" value={email} onChange={e => setEmail(e.target.value)}
            style={{ flex: 1, background: '#1E2418', border: '.5px solid #3D5030', borderRight: 'none', borderRadius: '2px 0 0 2px', padding: '14px 18px', color: '#EFE8D5', fontSize: 14, outline: 'none' }} />
          <button style={{ background: '#C8891F', color: '#0F1208', border: 'none', borderRadius: '0 2px 2px 0', padding: '14px 24px', fontSize: 12, fontWeight: 600, letterSpacing: '.10em', textTransform: 'uppercase', cursor: 'pointer', whiteSpace: 'nowrap' }}>Notify Me</button>
        </div>
        <div style={{ display: 'flex', justifyContent: 'center', gap: 24 }}>
          {[
            <svg key="ig" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor"/></svg>,
            <svg key="tt" width="18" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.93a8.18 8.18 0 0 0 4.78 1.52V7.01a4.85 4.85 0 0 1-1.01-.32z"/></svg>,
            <svg key="yt" width="22" height="16" viewBox="0 0 24 17" fill="currentColor"><path d="M23.5 2.7A3 3 0 0 0 21.4.6C19.5 0 12 0 12 0S4.5 0 2.6.6A3 3 0 0 0 .5 2.7C0 4.6 0 8.5 0 8.5s0 3.9.5 5.8a3 3 0 0 0 2.1 2.1c1.9.5 9.4.5 9.4.5s7.5 0 9.4-.5a3 3 0 0 0 2.1-2.1C24 12.4 24 8.5 24 8.5s0-3.9-.5-5.8zM9.7 12V5l6.3 3.5L9.7 12z"/></svg>,
          ].map((icon, i) => (
            <a key={i} href="#" className="nav-lnk" style={{ color: '#A89B80', transition: 'color .2s' }}>{icon}</a>
          ))}
        </div>
      </section>
