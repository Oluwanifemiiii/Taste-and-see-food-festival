...
export default function Events({ onNav }) {
  ...
  return (
    <main style={{ minHeight: '100vh', background: '#0F1208', paddingTop: 72 }}>
      <div style={{ maxWidth: 1440, margin: '0 auto', padding: '60px 48px' }}>
        <div style={{ marginBottom: 36 }}>
          <h1 style={{ fontSize: 48, fontFamily: "'Yeseva One',serif", color: '#EFE8D5', marginBottom: 32 }}>All Events</h1>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap' }}>
            ...
            <div style={{ marginLeft: 'auto', background: '#1E2418', border: '.5px solid #3D5030', borderRadius: 2, padding: '10px 16px', display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <input type="text" placeholder="Search events..." value={search} onChange={e => setSearch(e.target.value)}
                style={{ background: 'none', border: 'none', outline: 'none', color: '#EFE8D5', fontSize: 13, width: 180 }} />
            </div>
          </div>
        </div>
