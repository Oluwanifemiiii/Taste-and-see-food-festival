  ...
  return (
    <main style={{ minHeight: '100vh', background: '#0F1208', padding: '120px 48px 80px' }}>
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        <p style={{ fontSize: 10, fontWeight: 700, letterSpacing: '.18em', textTransform: 'uppercase', color: '#C8891F', marginBottom: 14 }}>Guest Account</p>
        <h1 style={{ fontSize: 48, fontFamily: "'Yeseva One',serif", color: '#EFE8D5', marginBottom: 16 }}>My Tickets & Bookings</h1>
        <p style={{ fontSize: 15, color: '#A89B80', lineHeight: 1.8, maxWidth: 620, marginBottom: 40 }}>This account area is ready for Supabase Auth. In demo mode it shows locally saved ticket orders from this browser.</p>
