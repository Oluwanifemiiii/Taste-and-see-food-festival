  ...
  return (
    <main style={{ minHeight: '100vh', background: '#0F1208', padding: `clamp(80px, 12vh, 100px) ${P} 80px` }}>
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        ...
        {step === 1 && (
          <section>
            <h1 style={{ fontSize: 'clamp(28px, 5vw, 40px)', fontFamily: "'Yeseva One',serif", color: '#EFE8D5', marginBottom: 8 }}>Choose your ticket</h1>
        ...
        {step === 2 && (
          <section>
            <h1 style={{ fontSize: 'clamp(24px, 4vw, 40px)', fontFamily: "'Yeseva One',serif", color: '#EFE8D5', marginBottom: 8 }}>Your details</h1>
            <p style={{ color: '#A89B80', marginBottom: 32 }}>These details are used for ticket delivery and gate check-in.</p>
            <div style={{ background: '#1E2418', border: '.5px solid #2A3020', borderRadius: 8, padding: 'clamp(20px, 4vw, 28px)', display: 'grid', gap: 18 }}>
        ...
        {step === 3 && (
          <section style={{ display: 'grid', gridTemplateColumns: '1fr 360px', gap: 28 }} className="col1">
            <div style={{ background: '#1E2418', border: '.5px solid #2A3020', borderRadius: 8, padding: 'clamp(20px, 4vw, 30px)' }}>
              <h1 style={{ fontSize: 'clamp(24px, 4vw, 36px)', fontFamily: "'Yeseva One',serif", color: '#EFE8D5', marginBottom: 20 }}>Payment</h1>
        ...
        {step === 4 && confirmedOrder && (
          <section style={{ textAlign: 'center', maxWidth: 640, margin: '0 auto' }}>
            ...
            <h1 style={{ fontSize: 'clamp(32px, 6vw, 44px)', fontFamily: "'Yeseva One',serif", color: '#EFE8D5', marginBottom: 12 }}>You're in.</h1>
